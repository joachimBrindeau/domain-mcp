...
2. Open an issue before a large change so the approach can be discussed.
...
Explain the problem, the chosen fix, and how you tested it. Add or update tests when behavior changes. Screenshots or sanitized API response shapes are helpful when they show a documentation or normalization issue.
