...
describeIntegration('dynadot_domain', () => {
  describe('read operations', () => {
    ...
    it('info - should get domain info', async () => {
      const result = await prodClient.execute('domain_info', { domain: TEST_DOMAIN });
      expect(getStatus(result)).toBe('success');
      expect(result.DomainInfoResponse).toBeDefined();
    });

    it('search - should check domain availability', async () => {
      const result = await prodClient.execute('search', {
    ...
    it('tld_price - should get TLD pricing', async () => {
      const result = await prodClient.execute('tld_price', { tld: 'com', currency: 'USD' });
      expect(getStatus(result)).toBe('success');
    });
  });
  ...
  describe('write operations (validation only)', () => {
    it('register - should validate domain registration params', async () => {
      ...
      const result = await sandboxClient.execute('register', {
    ...
    it('bulk_register - should validate bulk registration params', async () => {
      const result = await sandboxClient.execute('bulk_register', {
    ...
    it('renew - should check renewal price', async () => {
      const result = await sandboxClient.execute('renew', {
        domain: TEST_DOMAIN,
        duration: '1',
        currency: 'USD',
        price_check: '1',
    ...
    it('delete - should validate delete params', async () => {
      ...
      const result = await sandboxClient.execute('delete', {
    ...
    it('restore - should validate restore params', async () => {
      const result = await sandboxClient.execute('restore', {
        domain: 'nonexistent-test-domain.com',
      });
      expect(hasValidResponse(result)).toBe(true);
    });
    ...
    it('push - should validate push params', async () => {
      const result = await sandboxClient.execute('push', {
        domain: TEST_DOMAIN,
        username: 'test-user',
      });
      expect(hasValidResponse(result)).toBe(true);
...
describeIntegration('dynadot_domain_settings', () => {
  ...
  describe('write operations (validation only)', () => {
    it('set_ns - should validate nameserver params', async () => {
      const result = await sandboxClient.execute('set_ns', {
        domain: TEST_DOMAIN,
        ns0: 'ns1.example.com',
        ns1: 'ns2.example.com',
      });
    ...
    it('set_privacy - should validate privacy params', async () => {
      const result = await sandboxClient.execute('set_privacy', {
        domain0: TEST_DOMAIN,
        option: 'full',
      });
      expect(hasValidResponse(result)).toBe(true);
    ...
    it('set_whois - should validate WHOIS params', async () => {
      const result = await sandboxClient.execute('set_whois', {
        domain: TEST_DOMAIN,
    ...
    it('set_forwarding - should validate forwarding params', async () => {
      const result = await sandboxClient.execute('set_forwarding', {
        domain: TEST_DOMAIN,
    ...
    it('set_stealth - should validate stealth params', async () => {
      const result = await sandboxClient.execute('set_stealth', {
        domain: TEST_DOMAIN,
    ...
    it('set_parking - should validate parking params', async () => {
      const result = await sandboxClient.execute('set_parking', { domain: TEST_DOMAIN });
      expect(hasValidResponse(result)).toBe(true);
    });

    it('set_hosting - should validate hosting params', async () => {
      const result = await sandboxClient.execute('set_hosting', {
        domain: TEST_DOMAIN,
        hosting_type: 'basic',
      });
      expect(hasValidResponse(result)).toBe(true);
    ...
    it('set_email_forward - should validate email forward params', async () => {
      const result = await sandboxClient.execute('set_email_forward', {
        domain: TEST_DOMAIN,
    ...
    it('set_folder - should validate folder params', async () => {
      const result = await sandboxClient.execute('set_folder', {
        domain: TEST_DOMAIN,
        folder_id: '12345',
      });
      expect(hasValidResponse(result)).toBe(true);
    ...
    it('clear_settings - should validate clear settings params', async () => {
      const result = await sandboxClient.execute('set_clear_domain_setting', {
        domain: TEST_DOMAIN,
      });
      expect(hasValidResponse(result)).toBe(true);
    });
...
describeIntegration('dynadot_dns', () => {
  describe('read operations', () => {
    ...
    it('get_dnssec - should get DNSSEC status', async () => {
      const result = await prodClient.execute('get_dnssec', { domain_name: TEST_DOMAIN });
      expect(hasValidResponse(result)).toBe(true);
    });
  });
  ...
  describe('write operations (validation only)', () => {
    it('set - should validate DNS record params', async () => {
      const result = await sandboxClient.execute('set_dns2', {
        domain: TEST_DOMAIN,
        main_record_type0: 'A',
    ...
    it('set_dnssec - should validate DNSSEC params', async () => {
      const result = await sandboxClient.execute('set_dnssec', {
        domain: TEST_DOMAIN,
        key_tag: '12345',
        algorithm: '13',
        digest_type: '2',
    ...
    it('clear_dnssec - should validate clear DNSSEC params', async () => {
      const result = await sandboxClient.execute('clear_dnssec', { domain: TEST_DOMAIN });
      expect(hasValidResponse(result)).toBe(true);
    });
  });
});
...
describeIntegration('dynadot_nameserver', () => {
  ...
  describe('write operations (validation only)', () => {
    it('register - should validate register nameserver params', async () => {
      const result = await sandboxClient.execute('register_ns', {
    ...
    it('add - should validate add nameserver params', async () => {
      const result = await sandboxClient.execute('add_ns', { host: 'ns1.test-domain.com' });
      expect(hasValidResponse(result)).toBe(true);
    });

    it('set_ip - should validate set IP params', async () => {
      const result = await sandboxClient.execute('set_ns_ip', {
        host: 'ns1.test-domain.com',
        ip: '5.6.7.8',
      });
      expect(hasValidResponse(result)).toBe(true);
    ...
    it('delete - should validate delete nameserver params', async () => {
      const result = await sandboxClient.execute('delete_ns', { host: 'ns1.test-domain.com' });
      expect(hasValidResponse(result)).toBe(true);
    });

    it('delete_by_domain - should validate delete by domain params', async () => {
      const result = await sandboxClient.execute('delete_ns_by_domain', {
...
describeIntegration('dynadot_transfer', () => {
  describe('read operations', () => {
    ...
    it('get_auth_code - should get auth code', async () => {
      const result = await prodClient.execute('get_transfer_auth_code', { domain: TEST_DOMAIN });
      expect(hasValidResponse(result)).toBe(true);
    });

    it('get_push_request - should get push request', async () => {
      const result = await prodClient.execute('get_domain_push_request', { domain: TEST_DOMAIN });
      expect(hasValidResponse(result)).toBe(true);
    });
  });
  ...
  describe('write operations (validation only)', () => {
    it('initiate - should validate transfer params', async () => {
      const result = await sandboxClient.execute('transfer', {
    ...
    it('cancel - should validate cancel params', async () => {
      const result = await sandboxClient.execute('cancel_transfer', { domain: TEST_DOMAIN });
      expect(hasValidResponse(result)).toBe(true);
    });

    it('set_auth_code - should validate set auth code params', async () => {
      const result = await sandboxClient.execute('set_transfer_auth_code', {
        domain: TEST_DOMAIN,
    ...
    it('authorize_away - should validate authorize away params', async () => {
      const result = await sandboxClient.execute('authorize_transfer_away', {
        domain: TEST_DOMAIN,
      });
      expect(hasValidResponse(result)).toBe(true);
    });
    ...
    it('set_push_request - should validate set push request params', async () => {
      const result = await sandboxClient.execute('set_domain_push_request', {
        domain: TEST_DOMAIN,
        action: 'decline',
      });
      expect(hasValidResponse(result)).toBe(true);
...
describeIntegration('dynadot_contact', () => {
  describe('read operations', () => {
    ...
    it('get - should validate get contact params', async () => {
      const result = await prodClient.execute('get_contact', { contact_id: '12345' });
      expect(hasValidResponse(result)).toBe(true);
    });

    it('get_cn_audit_status - should validate CN audit status params', async () => {
      const result = await prodClient.execute('get_cn_audit_status', { contact_id: '12345' });
      expect(hasValidResponse(result)).toBe(true);
    });
  });
  ...
  describe('write operations (validation only)', () => {
    ...
    it('delete - should validate delete contact params', async () => {
      const result = await sandboxClient.execute('delete_contact', { contact_id: '12345' });
      expect(hasValidResponse(result)).toBe(true);
    });

    it('create_cn_audit - should validate CN audit params', async () => {
      const result = await sandboxClient.execute('create_cn_audit', {
        contact_id: '12345',
    ...
    it('set_eu_setting - should validate EU setting params', async () => {
      const result = await sandboxClient.execute('set_contact_eu_setting', {
        contact_id: '12345',
    ...
    it('set_lv_setting - should validate LV setting params', async () => {
      const result = await sandboxClient.execute('set_contact_lv_setting', {
        contact_id: '12345',
    ...
    it('set_lt_setting - should validate LT setting params', async () => {
      const result = await sandboxClient.execute('set_contact_lt_setting', {
        contact_id: '12345',
...
describeIntegration('dynadot_folder', () => {
  ...
  describe('write operations (validation only)', () => {
    it('create - should validate create folder params', async () => {
      const result = await sandboxClient.execute('create_folder', { folder_name: 'Test Folder' });
      expect(hasValidResponse(result)).toBe(true);
    });

    it('delete - should validate delete folder params', async () => {
      const result = await sandboxClient.execute('delete_folder', { folder_id: '12345' });
      expect(hasValidResponse(result)).toBe(true);
    });
    ...
    it('set_whois - should validate folder WHOIS params', async () => {
      const result = await sandboxClient.execute('set_folder_whois', {
        folder_id: '12345',
        contact_id: '67890',
      });
      expect(hasValidResponse(result)).toBe(true);
    ...
    it('set_ns - should validate folder nameserver params', async () => {
      const result = await sandboxClient.execute('set_folder_ns', {
        folder_id: '12345',
        ns0: 'ns1.example.com',
        ns1: 'ns2.example.com',
      });
    ...
    it('set_parking - should validate folder parking params', async () => {
      const result = await sandboxClient.execute('set_folder_parking', { folder_id: '12345' });
      expect(hasValidResponse(result)).toBe(true);
    });

    it('set_forwarding - should validate folder forwarding params', async () => {
      const result = await sandboxClient.execute('set_folder_forwarding', {
        folder_id: '12345',
        forward_url: 'https://example.com',
      });
      expect(hasValidResponse(result)).toBe(true);
    ...
    it('set_stealth - should validate folder stealth params', async () => {
      const result = await sandboxClient.execute('set_folder_stealth', {
        folder_id: '12345',
        stealth_url: 'https://example.com',
      });
      expect(hasValidResponse(result)).toBe(true);
    ...
    it('set_hosting - should validate folder hosting params', async () => {
      const result = await sandboxClient.execute('set_folder_hosting', {
        folder_id: '12345',
        hosting_type: 'basic',
      });
      expect(hasValidResponse(result)).toBe(true);
    ...
    it('set_dns - should validate folder DNS params', async () => {
      const result = await sandboxClient.execute('set_folder_dns', {
        folder_id: '12345',
        main_record_type0: 'A',
        main_record0: '1.2.3.4',
      });
    ...
    it('set_dns2 - should validate folder DNS2 params', async () => {
      const result = await sandboxClient.execute('set_folder_dns2', {
        folder_id: '12345',
        main_record_type0: 'A',
        main_record0: '1.2.3.4',
      });
    ...
    it('set_email_forward - should validate folder email forward params', async () => {
      const result = await sandboxClient.execute('set_folder_email_forward', {
        folder_id: '12345',
        email: 'test@example.com',
      });
      expect(hasValidResponse(result)).toBe(true);
    ...
    it('set_renew_option - should validate folder renew option params', async () => {
      const result = await sandboxClient.execute('set_folder_renew_option', {
        folder_id: '12345',
        renew_option: 'auto',
      });
      expect(hasValidResponse(result)).toBe(true);
    ...
    it('clear_settings - should validate folder clear settings params', async () => {
      const result = await sandboxClient.execute('set_clear_folder_setting', {
        folder_id: '12345',
      });
      expect(hasValidResponse(result)).toBe(true);
    });
...
describeIntegration('dynadot_account', () => {
  describe('read operations', () => {
    ...
    it('balance - should get account balance or report no balance', async () => {
      const result = await prodClient.execute('get_account_balance', { currency: 'USD' });
      expect(hasValidResponse(result)).toBe(true);
    });
  });
  ...
  describe('write operations (validation only)', () => {
    it('set_default_whois - should validate default WHOIS params', async () => {
      const result = await sandboxClient.execute('set_default_whois', { contact_id: '12345' });
      expect(hasValidResponse(result)).toBe(true);
    });

    it('set_default_ns - should validate default nameserver params', async () => {
      const result = await sandboxClient.execute('set_default_ns', {
        ns0: 'ns1.example.com',
        ns1: 'ns2.example.com',
      });
      expect(hasValidResponse(result)).toBe(true);
    ...
    it('set_default_parking - should validate default parking params', async () => {
      const result = await sandboxClient.execute('set_default_parking');
      expect(hasValidResponse(result)).toBe(true);
    });

    it('set_default_forwarding - should validate default forwarding params', async () => {
      const result = await sandboxClient.execute('set_default_forwarding', {
        forward_url: 'https://example.com',
      });
      expect(hasValidResponse(result)).toBe(true);
    });
    ...
    it('set_default_stealth - should validate default stealth params', async () => {
      const result = await sandboxClient.execute('set_default_stealth', {
        stealth_url: 'https://example.com',
      });
      expect(hasValidResponse(result)).toBe(true);
    });
    ...
    it('set_default_hosting - should validate default hosting params', async () => {
      const result = await sandboxClient.execute('set_default_hosting', { hosting_type: 'basic' });
      expect(hasValidResponse(result)).toBe(true);
    });

    it('set_default_dns - should validate default DNS params', async () => {
      const result = await sandboxClient.execute('set_default_dns', {
        main_record_type0: 'A',
        main_record0: '1.2.3.4',
      });
      expect(hasValidResponse(result)).toBe(true);
    ...
    it('set_default_dns2 - should validate default DNS2 params', async () => {
      const result = await sandboxClient.execute('set_default_dns2', {
        main_record_type0: 'A',
        main_record0: '1.2.3.4',
      });
      expect(hasValidResponse(result)).toBe(true);
    ...
    it('set_default_email_forward - should validate default email forward params', async () => {
      const result = await sandboxClient.execute('set_default_email_forward', {
        email: 'test@example.com',
      });
      expect(hasValidResponse(result)).toBe(true);
    });
    ...
    it('set_default_renew_option - should validate default renew option params', async () => {
      const result = await sandboxClient.execute('set_default_renew_option', {
        renew_option: 'auto',
      });
      expect(hasValidResponse(result)).toBe(true);
    });
    ...
    it('clear_defaults - should validate clear defaults params', async () => {
      const result = await sandboxClient.execute('set_clear_default_setting');
      expect(hasValidResponse(result)).toBe(true);
    });
  });
});
...
describeIntegration('dynadot_aftermarket', () => {
  ...
  describe('regular auctions', () => {
    it('auction_list_open - should list open auctions', async () => {
      const result = await prodClient.execute('get_open_auctions', { currency: 'USD' });
      expect(hasValidResponse(result)).toBe(true);
    });

    it('auction_list_closed - should list closed auctions', async () => {
      const result = await prodClient.execute('get_closed_auctions');
      expect(hasValidResponse(result)).toBe(true);
    });

    it('auction_details - should validate auction details params', async () => {
      const result = await prodClient.execute('get_auction_details', { auction_id: '12345' });
      expect(hasValidResponse(result)).toBe(true);
    });

    it('auction_bids - should validate auction bids params', async () => {
      const result = await prodClient.execute('get_auction_bids', { auction_id: '12345' });
      expect(hasValidResponse(result)).toBe(true);
    });
  ...
  describe('backorder auctions', () => {
    it('backorder_auction_list_open - should list open backorder auctions', async () => {
      ...
      try {
        const result = await prodClient.execute('get_open_backorder_auctions', { currency: 'USD' });
        expect(hasValidResponse(result) || result).toBeTruthy();
      } catch {
    ...
    it('backorder_auction_list_closed - should list closed backorder auctions', async () => {
      const result = await prodClient.execute('get_closed_backorder_auctions');
      expect(hasValidResponse(result)).toBe(true);
    });

    it('backorder_auction_details - should validate backorder auction details params', async () => {
      const result = await prodClient.execute('get_backorder_auction_details', {
        auction_id: '12345',
      });
      expect(hasValidResponse(result)).toBe(true);
    });
  ...
  describe('expired closeouts', () => {
    it('expired_list - should list expired closeout domains', async () => {
      const result = await prodClient.execute('get_expired_closeout_domains', { currency: 'USD' });
      expect(hasValidResponse(result)).toBe(true);
    });
  ...
  describe('marketplace', () => {
    it('listings - should get marketplace listings', async () => {
      const result = await prodClient.execute('get_listings', { currency: 'USD' });
      expect(hasValidResponse(result)).toBe(true);
    });

    it('listing_details - should validate listing details params', async () => {
      const result = await prodClient.execute('get_listing_item', { domain: 'test-listing.com' });
      expect(hasValidResponse(result)).toBe(true);
    });
...
describeIntegration('dynadot_order', () => {
  describe('read operations', () => {
    it('list - should list recent orders', async () => {
      ...
      const result = await prodClient.execute('order_list', {
        search_by: 'date',
    ...
    it('status - should validate order status params', async () => {
      const result = await prodClient.execute('get_order_status', { order_id: '12345' });
      expect(hasValidResponse(result)).toBe(true);
    });

    it('is_processing - should check processing status', async () => {
      const result = await prodClient.execute('is_processing');
      expect(getStatus(result)).toBe('success');
    });

    it('coupons - should list available coupons', async () => {
      const result = await prodClient.execute('list_coupons', { coupon_type: 'all' });
      expect(hasValidResponse(result)).toBe(true);
    });
  });
